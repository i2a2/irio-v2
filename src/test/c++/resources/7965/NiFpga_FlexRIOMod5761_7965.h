 ...
 */
static const char* const NiFpga_FlexRIOMod5761_7965_Signature = "666521838E4814E619FD3126827F6593";

typedef enum
{
   NiFpga_FlexRIOMod5761_7965_IndicatorBool_InitDone = 0xEE,
   NiFpga_FlexRIOMod5761_7965_IndicatorBool_RIOAdapterCorrect = 0xF2,
...
typedef enum
{
   NiFpga_FlexRIOMod5761_7965_IndicatorU8_DevProfile = 0xE2,
   NiFpga_FlexRIOMod5761_7965_IndicatorU8_DevQualityStatus = 0x5A,
   NiFpga_FlexRIOMod5761_7965_IndicatorU8_Platform = 0xFE,
...
typedef enum
{
   ...
   NiFpga_FlexRIOMod5761_7965_IndicatorI32_auxAI10 = 0x18,
   ...
   NiFpga_FlexRIOMod5761_7965_IndicatorI32_auxAI9 = 0x14,
} NiFpga_FlexRIOMod5761_7965_IndicatorI32;

typedef enum
{
   NiFpga_FlexRIOMod5761_7965_IndicatorU32_ExpectedIOModuleID = 0xF8,
   NiFpga_FlexRIOMod5761_7965_IndicatorU32_Fref = 0xE8,
   NiFpga_FlexRIOMod5761_7965_IndicatorU32_InsertedIOModuleID = 0xF4,
   NiFpga_FlexRIOMod5761_7965_IndicatorU32_SGFref0 = 0xC4,
   NiFpga_FlexRIOMod5761_7965_IndicatorU32_SGFref1 = 0x5C,
} NiFpga_FlexRIOMod5761_7965_IndicatorU32;

typedef enum
{
   NiFpga_FlexRIOMod5761_7965_IndicatorI64_aux64AI0 = 0xC8,
} NiFpga_FlexRIOMod5761_7965_IndicatorI64;
...
typedef enum
{
   ...
   NiFpga_FlexRIOMod5761_7965_ControlU16_SGAmp0 = 0x12,
   NiFpga_FlexRIOMod5761_7965_ControlU16_SGAmp1 = 0x36,
} NiFpga_FlexRIOMod5761_7965_ControlU16;

typedef enum
{
   NiFpga_FlexRIOMod5761_7965_ControlI32_AO0 = 0x4,
...
typedef enum
{
   NiFpga_FlexRIOMod5761_7965_ControlU32_SGFreq0 = 0xC,
   NiFpga_FlexRIOMod5761_7965_ControlU32_SGFreq1 = 0x30,
   NiFpga_FlexRIOMod5761_7965_ControlU32_SGPhase0 = 0x8,
   NiFpga_FlexRIOMod5761_7965_ControlU32_SGPhase1 = 0x2C,
   NiFpga_FlexRIOMod5761_7965_ControlU32_SGUpdateRate0 = 0x0,
   NiFpga_FlexRIOMod5761_7965_ControlU32_SGUpdateRate1 = 0x20,
   NiFpga_FlexRIOMod5761_7965_ControlU32_TabControl = 0x104,
} NiFpga_FlexRIOMod5761_7965_ControlU32;

typedef enum
{
   NiFpga_FlexRIOMod5761_7965_ControlI64_aux64AO0 = 0xCC,
} NiFpga_FlexRIOMod5761_7965_ControlI64;

typedef enum
{
   NiFpga_FlexRIOMod5761_7965_IndicatorArrayU8_DMATtoHOSTFrameType = 0xD6,
   NiFpga_FlexRIOMod5761_7965_IndicatorArrayU8_DMATtoHOSTSampleSize = 0xDA,
   NiFpga_FlexRIOMod5761_7965_IndicatorArrayU8_FPGAVIversion = 0xE6,
...
typedef enum
{
   NiFpga_FlexRIOMod5761_7965_IndicatorArrayU16_DMATtoHOSTBlockNWords = 0xDE,
   NiFpga_FlexRIOMod5761_7965_IndicatorArrayU16_DMATtoHOSTNCh = 0xD2,
