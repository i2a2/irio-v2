...
// CPUIMAQ bitfile
TEST(TP_Rseries_onlyResources, CPUIMAQ)
{
	string testName = "TP_Rseries_onlyResources: Functional test of bitfile CPUIMAQ";
	string testDescription = "Test verifies driver’s ability to read and testing resources in the FPGA.";
	...
	string NIRIOmodel = "PXI-"+RIODevice+"R";
	string bitfileName = "Rseries_CPUIMAQ_"+RIODevice;
